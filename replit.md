...
## Recent Changes
- **2025-11-07**: Implemented comprehensive sitemap.xml endpoint for SEO optimization. GET /sitemap.xml automatically lists all public URLs including: 22 static front pages (6 services at priority 0.9, 6 company pages at 0.8, 5 support pages at 0.7, 4 legal pages at 0.5, referral program at 0.6), plus all dynamic content (quotes, invoices, projects, tickets with shareTokens). Updated robots.txt to reference sitemap dynamically using request host. Total 31+ URLs indexed with proper lastmod timestamps, priorities, and change frequencies for optimal search engine discovery.
